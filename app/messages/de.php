...
$messages = array(
	...
	"feusersIndexTitle" => "Nutzer",
	"welcome" => "Herzlich willkommen bei den Rapsexperten!",
	"welcomeInfo" => "Bitte berühren.",
	"button1" => "Quiz",
	"button2" => "Sorten-<br>Infos<br> kompakt",
	"button3" => "Kontakt zu den Rapsexperten",
	"button4" => "Meine<br>rapsexperten.de",
	"listHeader" => "Heute für mich am Stand.",
	"listHeaderInfo" => "Übersicht aller Ansprechpartner vor Ort.",
	"contactHeader" => "Kontakt zu meinem Berater.",
	"contactHeaderInfo" => "Unsere Berater stehen Ihnen für alle Fragen zum Raps zur Verfügung.",
	"contactInfo" => "Zur Kontaktaufnahme benötigen wir folgende persönliche Informationen",
	"mandatory" => "Pflichtfelder",
	"searchHeader" => "Kontakt zu meinem Berater.",
	"searchHeaderInfo" => "Unsere Berater stehen Ihnen für alle Fragen zum Raps zur Verfügung.",
	...
	"no" => "Nein",
	"zip" => "PLZ",
	"yourzip" => "Ihre Postleitzahl",
	"yourcity"=>"Ihr Wohnort",
	"city" => "Ort",
	"email" => "Mailadresse",	
	"premessage" => "Wählen Sie einen vorgefertigten Text<br> oder geben Sie Ihre eigene Nachricht ein.",
	"message" => "Ihr Text:",
	"title" => "Titel",
	"salutation" => "Anrede",
	"company" => "Unternehmen",
	...
	"submitSMS" => "Nachricht abschicken",
	...
	"q_7_11" => "Sonstiges",
	"question_8" => "Woher kommen Sie? Falls Sie aus Deutschland kommen, nennen Sie uns bitte die 1. Stelle Ihrer PLZ.",
	"q_8_1"	 => "0",
	"q_8_2"	 => "1",
	"q_8_3"	 => "2",
	"q_8_4"	 => "3",
	...
	"q_2_1_b_title"=>"Darstellung folgender Produkte/Themen:",
	"q_2_1_b"	 => "&mdash; Smart Farming",
	"q_2_2_b"	 => "&mdash; Agrar",
	"q_2_3_b"	 => "&mdash; Technik/Service",
	"q_2_4_b"	 => "&mdash; eCommerce",
	"q_2_5_b"	 => "&mdash; Personal",
	"q_2_6_b"	 => "Rückzugsmöglichkeiten für Kundengespräche",
	"q_2_7_b"	 => "Medieneinsatz (z.B. Videos und Filme)",
	"q_2_8_b"	 => "Werbegeschenke",
	"q_2_9_b"	 => "Bewirtung",
	...
	"q_10_4_b" => "Anzahl Kontakte potenzieller Mitarbeiter",
	"q_10_b_add" =>"Wo gab es Schwierigkeiten?",
	"question_11_b" => "Wie beurteilen Sie die Stände der Konkurrenz und Nachbarn allgemein?",
